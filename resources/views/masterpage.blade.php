...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>PT</b>BSP</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b></b>PT. BinaSentra Purna</span>
    </a>
              ...
              @if (Auth::user()->role_type == "GA")
                  <li class="treeview" id="menu_master">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li id="submenu_policies"><a href="{{url('policies')}}"><i class="fa fa-inbox"></i> Data Polis</a></li>
                      <li id="submenu_buildings"><a href="{{url('buildings')}}"><i class="fa fa-inbox"></i> Data Tipe Bangunan</a></li>
                      <li id="submenu_trees"><a href="{{url('trees')}}"><i class="fa fa-inbox"></i> Data Kantor Cabang</a></li>
                    </ul>
                  </li>               
                @endif           
          </ul>
